            ...
            @forelse($produk->ulasan as $review)
                <article>
                    <div class="review-head">
                        <div>
                            <strong>{{ $review->pembeli->nama_lengkap }}</strong>
                    ...
                    <p>{{ $review->komentar ?: 'Pembeli memberi penilaian tanpa komentar.' }}</p>
                </article>
            @empty
                <div class="empty-inline">Belum ada ulasan untuk produk ini.</div>
            @endforelse
        </div>
    </div>
</section>
