...
<header class="site-header {{ request()->routeIs('home') ? 'site-header-overlay' : 'site-header-solid' }}" id="siteHeader">
    <div class="shell header-inner">
        <a class="brand" href="{{ route('home') }}"><span class="brand-mark">LM</span><span><b>LUDES</b>-MARKET<small>Moncongloe Lappara</small></span></a>
...
<footer class="site-footer" id="kontak"><div class="shell footer-grid"><div><a class="brand footer-brand" href="{{ route('home') }}"><span class="brand-mark">LM</span><span><b>LUDES</b>-MARKET<small>Moncongloe Lappara</small></span></a><p>Platform Pemasaran Digital Produk Lokal BUMDes untuk Memperluas Akses Pasar dan Mendorong Kemandirian Ekonomi Desa Moncongloe Lappara.</p></div><div><h4>Jelajahi</h4><a href="{{ route('catalogue') }}">Katalog Produk</a><a href="{{ route('home') }}#mitra">Mitra UMKM</a><a href="{{ route('register') }}">Jadi Mitra</a></div><div><h4>Lokasi & Kontak Admin</h4><p>Desa Moncongloe Lappara<br>Kabupaten Maros, Sulawesi Selatan</p><p><i class="bi bi-geo-alt"></i> Kawasan Kuliner Moncongloe Lappara</p><p><i class="bi bi-telephone-fill" style="color:var(--gold)"></i> <a href="https://wa.me/6281234500001" target="_blank" rel="noopener" style="color:inherit">0812-3450-0001 (Admin)</a></p><p><i class="bi bi-envelope-fill" style="color:var(--gold)"></i> <a href="mailto:admin@bumdesberkah.id" style="color:inherit">admin@bumdesberkah.id</a></p></div></div><div class="shell footer-bottom"><span>© {{ date('Y') }} LUDES-MARKET</span><span>Produk lokal. Dikelola lebih rapi.</span></div></footer>
