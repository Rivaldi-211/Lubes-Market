...
class Produk extends Model
{
    ...
    protected $fillable=['umkm_id','kategori_id','kelompok_keroyokan_id','nama_produk','harga','stok_status','stok_jumlah','estimasi_po_hari','deskripsi','foto'];
    protected function casts(): array { return ['harga'=>'decimal:2','stok_jumlah'=>'integer','estimasi_po_hari'=>'integer']; }
